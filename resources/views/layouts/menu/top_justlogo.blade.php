            ...
            @isset($restorant)
                ...
                @if(config('app.isqrsaas'))
                  ...
                  @if(config('settings.enable_guest_log'))
                    <li class="web-menu mr-1">
                      <a  href="{{ route('register.claimowner',['restaurant_id'=>$restorant->id])}}" class="btn btn-neutral btn-icon btn-cart" style="cursor:pointer;">
                            <span class="btn-inner--icon">
                              <i class="fa fa-check"></i>
                            </span>
                            <span class="nav-link-inner--text">{{ __('Claim Ownership') }}</span>
                        </a>
                    </li>
