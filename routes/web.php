...
//ownership confirmation - restaurant
Route::get('register/claimowner/{restaurant_id}', 'VisitsController@claimOwnership')->name('register.claimowner');
Route::post('register/claimowner', 'VisitsController@claimOwnershipStore')->name('register.claimowner.store');
